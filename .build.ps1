...
param(
    ...
    [ValidateSet('Init', 'Clean', 'Build', 'Lint', 'UnitTest', 'IntegrationTest', 'TestAll', 'UpdateMarkdownHelp', 'ExternalHelp', 'ReleaseNotes', 'Stage', 'Import', 'ValidateReleaseMetadata', 'ReleaseTestAll', 'ReleaseTag', 'Release')]
